...
@section('title', 'Tambah Data Daftar Paket')
...
id="id_paket_wisata" value="{{old('id_paket_wisata')}}">
 <input type="text" class="form-control
@error('diskon') is-invalid @enderror" placeholder="ID Paket Wisata"
id="diskon" name="diskon" value="{{old('diskon')}}" arialabel="Bidang Studi" aria-describedby="cari" readonly>
 <button class="btn btn-warning" type="button"
data-bs-toggle="modal" id="cari" data-bs-target="#staticBackdrop"></i>
Cari Data Id Paket Wisata</button>
 </div>
 </div>
...
placeholder="Masukan jumlah_peserta Lengkap" name="jumlah_peserta"
value="{{old('jumlah_peserta')}}">
 ...
 <input type="text" class="form-control
@error('harga_paket') is-invalid @enderror" id="harga_paket"
placeholder="Masukan Nominal" name="harga_paket"
