...
@section('content_header')
 <h1 class="m-0 text-dark">Tambah Data Paket Wisata</h1>
@stop
@section('content')
...
placeholder="Masukkan deskripsi" name="deskripsi" value="{{old('deskripsi')}}">
...
placeholder="Masukan Fasilitas" name="fasilitas" value="{{old('fasilitas')}}">
 ...
 <input type="text" class="form-control
@error('itinerary') is-invalid @enderror" id="itinerary"
placeholder="Masukan Itinerary" name="itinerary" value="{{old('itinerary')}}">
...
placeholder="Masukan Diskon" name="diskon" value="{{old('diskon')}}">
