...
placeholder="Masukan Nama Karyawan" name="nama_karyawan" value="{{old('nama_karyawan')}}">
...
value="{{old('no_hp')}}">
 ...
 <option value="administrasi" @if(old('jabatan') ==
'administrasi')selected @endif>Administrasi</option>
